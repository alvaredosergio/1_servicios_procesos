    ...
    public static void main(String[] args) {
        ...
        try {
            while(true){
                ...
                int psw = scn2.nextInt();
            
                if(user.equals(u.getName()) && psw == 1234){
                    ...
                    System.out.println("El " + cyan + "USUARIO"+ reset +" o "+ cyan + "CONTRASEÑA" + reset + " son " + red + "INCORRECTAS" + reset + ". Pruebe de nuevo.");
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
